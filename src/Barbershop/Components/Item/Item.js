            ...
            <Context.Consumer>
                {
                    (Context) => {
                        ...
                        function changeImage(id, imgname) {
                            document.querySelector('.slider__main__img').src = require('../../Styles/Components/Item/item' + (id + 1) + imgname)
                        }
                                            ...
                                            <div className="df_col col-6">
                                                <div className="df_col slider df_jcsb">
                                                    ...
                                                    <div className="df_jcsb ">
                                                        <img
                                                            className="slider__secondary__img"
                                                            src={require('../../Styles/Components/Item/item' + (id + 1) + '.png')}
                                                            alt='item_image_1'
                                                            onClick={() => changeImage(id, '.png')}
                                                        />
                                                        <img
                                                            className="slider__secondary__img"
                                                            src={require('../../Styles/Components/Item/item' + (id + 1) + '_2.png')}
                                                            alt='item_image_2'
                                                            onClick={() => changeImage(id, '_2.png')}
                                                        />
                                                        <img
                                                            className="slider__secondary__img"
                                                            src={require('../../Styles/Components/Item/item' + (id + 1) + '_3.png')}
                                                            alt='item_image_3'
                                                            onClick={() => changeImage(id, '_3.png')
                                                            } />
                                                    </div>
                                                </div>
                                            </div>
